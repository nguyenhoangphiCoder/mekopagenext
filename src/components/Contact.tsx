...
export default function Contact() {
  return (
    // <div className="flex h-[413px] mx-auto  justify-center mt-50 items-center  flex-col w-full  ">
    ...
    //     </p>
    //     <button className="w-[133px] font-barlow h-[36px] text-[14px] mt-50 text-center text-[#fff] bg-[#ec500d] hover:bg-[#d7440a] absolute transition rounded-[51px]">
    //       Liên Hệ
    //     </button>
    //   </div>
