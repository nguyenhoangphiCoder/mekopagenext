...
export default function InforCompany({ settings }: any) {
  return (
    <div className="h-[508px] w-[306px] flex flex-col  gap-[24px]">
      <div className="h-[153px] w-[306px] rounded-[10px] flex justify-center items-center bg-[#fbfbfb]">
        <ul className="flex flex-col gap-[5px] justify-center items-center">
          <li className="w-[42px] h-[42px] bg-gray-100 rounded-[100px] flex justify-center items-center">
      ...
      <div className="h-[153px] w-[306px] rounded-[10px] flex justify-center items-center bg-[#fafafa]">
        <ul className="flex flex-col gap-[5px] justify-center items-center">
          ...
          <li
            className="whitespace-pre-line font-fira-sans text-[14px] text-center leading-[1.2rem] font-[500]"
